 ...
 */
public interface UserBoManager extends GenericManager<User, Long> {
    /**
     * Convenience method for testing - allows you to mock the DAO and set it on an interface.
     * @param userDao the UserDao implementation to use
     */
    void setUserDao(IUserBoDao userDao);
     ...
     * @throws fr.k2i.adbeback.service.UserExistsException thrown when user already exists
